...
export function setupReporteController(containerElement, onBackToDashboard) {
  ...
  async function generateReport() {
    reportOutput.innerHTML = '<p class="loading-message">Generando reporte...</p>';
